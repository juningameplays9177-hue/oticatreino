<x-app-layout title="Editar Usuário">
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-sm text-slate-600">Atualize as informações do usuário</p>
            </div>
                ...
                <form method="POST" action="{{ route('users.update', $user) }}" class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs text-slate-500 flex items-start">
                            ...
                            <span>Mínimo de 8 caracteres. Deixe em branco se não quiser alterar a senha.</span>
                        </p>
                    </div>
                    ...
                    <div id="store_field" style="display: {{ old('role', $user->role) === 'gerente' ? 'block' : 'none' }};">
