    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-4 md:p-6">
            <div class="flex items-center justify-between mb-4">
                <h1 class="text-xl md:text-2xl font-bold text-slate-900">Novo Fornecedor</h1>
            ...
            <form method="POST" action="{{ route('cadastros.suppliers.store') }}">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select id="tax_id_type" name="tax_id_type" required onchange="toggleTaxId()" class="w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            ...
                            <option value="CNPJ" {{ old('tax_id_type', 'CNPJ') === 'CNPJ' ? 'selected' : '' }}>CNPJ</option>
                        </select>
                    </div>

                    <div class="md:col-span-2">
                        <label for="trade_name" class="block text-sm font-medium text-slate-700 mb-1">Nome Fantasia *</label>
                        <input type="text" id="trade_name" name="trade_name" value="{{ old('trade_name') }}" required class="w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>

                    <div class="md:col-span-2">
                        <label for="legal_name" class="block text-sm font-medium text-slate-700 mb-1">Razão Social</label>
                        <input type="text" id="legal_name" name="legal_name" value="{{ old('legal_name') }}" class="w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    ...
                    <div id="cnpj_field" class="{{ old('tax_id_type', 'CNPJ') === 'CNPJ' ? '' : 'hidden' }}">
                        <label for="cnpj" class="block text-sm font-medium text-slate-700 mb-1">CNPJ *</label>
                        <input type="text" id="cnpj" name="cnpj" value="{{ old('cnpj') }}" placeholder="00.000.000/0000-00" class="w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    ...
                    <div>
                        <label class="flex items-center">
                            <input type="checkbox" name="is_lab" value="1" {{ old('is_lab') ? 'checked' : '' }} class="rounded border-slate-300 text-blue-600 focus:ring-blue-500">
                    ...
                    <div>
                        <label class="flex items-center">
                            <input type="checkbox" name="taxpayer_icms" value="1" {{ old('taxpayer_icms') ? 'checked' : '' }} class="rounded border-slate-300 text-blue-600 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <input type="text" id="ie" name="ie" value="{{ old('ie') }}" class="w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>

                    <div>
                        <label for="im" class="block text-sm font-medium text-slate-700 mb-1">Inscrição Municipal (IM)</label>
                        <input type="text" id="im" name="im" value="{{ old('im') }}" class="w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>

                    <div>
                        <label for="suframa" class="block text-sm font-medium text-slate-700 mb-1">SUFRAMA</label>
                        <input type="text" id="suframa" name="suframa" value="{{ old('suframa') }}" class="w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}" class="w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>

                    <div>
                        <label for="website" class="block text-sm font-medium text-slate-700 mb-1">Website</label>
                        <input type="url" id="website" name="website" value="{{ old('website') }}" placeholder="https://..." class="w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="number" name="number" value="{{ old('number') }}" class="w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>

                    <div>
                        <label for="complement" class="block text-sm font-medium text-slate-700 mb-1">Complemento</label>
                        <input type="text" id="complement" name="complement" value="{{ old('complement') }}" class="w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
