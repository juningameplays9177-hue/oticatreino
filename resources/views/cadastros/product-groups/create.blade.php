<x-app-layout title="Nova Categoria">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-xl font-bold text-slate-900">Nova Categoria</h1>
            ...
            <form method="POST" action="{{ route('cadastros.product-groups.store') }}">
                @csrf
                <div class="mb-4">
